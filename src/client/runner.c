...
int run_client(int sock_fd) {
	...
	printf("%d %d %d %d\n", game->board.board[0][0].moves, game->board.board[0][7].moves, game->board.board[7][0].moves, game->board.board[7][7].moves);
	printf("%d %d\n", game->board.board[0][4].moves, game->board.board[7][4].moves);
